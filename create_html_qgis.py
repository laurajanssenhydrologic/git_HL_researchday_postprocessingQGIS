...
#kpi["image_path"]="file:///"+image_path+kpi["CODE"]+ ".png"
...
kpi.to_file(r"D:\work\P23006\Figuren_output\QGIS_html\V2022\geopackages\KPI.gpkg",index=False)
...
peilgebied_def.to_file(r"D:\work\P23006\Figuren_output\QGIS_html\V2022\geopackages\peilgebied.gpkg",index=False)
#%%
waterloop=gpd.read_file(r"D:\work\P23006\GIS\HYDAMO\HDSR_28.gpkg",layer="waterloop")
waterloop_def=waterloop[["code","geometry"]]
waterloop_def.to_file(r"D:\work\P23006\Figuren_output\QGIS_html\V2022\geopackages\waterloop.gpkg",index=False)
# %%
